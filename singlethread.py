...
if __name__ == '__main__':
    ...
    print("------Start processing storage------")
    ...
    print("------Finish processing storage------\n")

    print("------Start processing Alert system------")
    ...
    print("------Finish processing Alert system------\n")

    print("------Start processing AI predicting------")
    ...
    print("------Finish processing AI predicting------")
